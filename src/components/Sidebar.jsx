...
function Sidebar(props) {
  ...
  return (
    <div className="sidebar-container">
           <NavLink exact to="/admin" className="normal-sidebar" activeClassName="active-sidebar" >Ajout Catalogue</NavLink>
           <NavLink exact to="/categorie" className="normal-sidebar" activeClassName="active-sidebar" >Ajout Catégorie</NavLink>
           <NavLink exact to="/users" className="normal-sidebar" activeClassName="active-sidebar" >Ajout Article</NavLink>
